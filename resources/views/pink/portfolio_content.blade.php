            ...
            <div id="portfolio" class="portfolio-full-description">
                ...
                <div class="portfolios hentry work group">
                    <div class="work-thumbnail">
                        <a class="thumb"><img src="{{ asset(Config::get('settings.theme')) }}/images/projects/{{ $portfolio->img->path }}" alt="0081" title="{{ $portfolio->title }}" /></a>
                    </div>
                ...
                <div class="portfolio-full-description-related-projects">
                    ...
                    <div class="related_project">
                        <a class="related_proj related_img" href="{{ route('portfolios.show',['alias'=>$portfolio->alias]) }}">{{ $portfolio->title }}" title="{{ $portfolio->title }}"><img src="{{ asset(Config::get('settings.theme')) }}/images/projects/{{ $portfolio->img->mini }}" alt="0061" title="{{ $portfolio->title }}" /></a>
