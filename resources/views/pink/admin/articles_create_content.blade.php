<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open(['url' => (isset($article->id)) ? route('admin.articles.update',$article) : route('admin.articles.store'),'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
        ...
        <ul>
            ...
            @if(isset($article->img->path))
                <li class="textarea-field">
                    ...
                    {{ Html::image(asset(Config::get('settings.theme')).'/images/articles/'.$article->img->path,'',['style'=>'width:400px']) }}
