            ...
            <div class="recent-post group">
                @foreach($articles as $article)
                    <div class="hentry-post group">
                        <div class="thumb-img"><img src="{{ asset(Config::get('settings.theme')) }}/images/articles/{{ $article->img->mini }}" alt="001" title="001" /></div>
                        <div class="text">
    ...
    <div class="widget-last widget text-image">
        ...
        <div class="text-image" style="text-align:left"><img src="{{ asset(Config::get('settings.theme')) }}/images/callus.gif" alt="Customer support" /></div>
