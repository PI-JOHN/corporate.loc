                            ...
                            <div class="hentry work group portfolio-sticky portfolio-full-description">
                                <div class="work-thumbnail">
                                    ...
                                    <div class="work-overlay">
                                        ...
                                        <p class="work-overlay-categories"><img src="{{ asset(env('THEME')) }}/images/categories.png" alt="Categories" /> in: <a href="{{ asset(env('THEME')) }}/category.html">Brand Identity</a>, <a href="category.html">Web Design</a></p>
                                    </div>
                                </div>
                                <div class="work-description">
                                    <h2><a href="{{ asset(env('THEME')) }}/project.html">Steep This!</a></h2>
                                    <p class="work-categories">in: <a href="{{ asset(env('THEME')) }}/category.html">Brand Identity</a>, <a href="{{ asset(env('THEME')) }}/category.html">Web Design</a></p>
                                    ...
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            ...
                                            <div class="overlay">
                                                ...
                                                <a class="overlay_project" href="{{ asset(env('THEME')) }}/project.html"></a>
                    ...
                    <div class="widget-first widget recent-posts">
                        ...
                        <div class="recent-post group">
                            <div class="hentry-post group">
                                ...
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html" title="Section shortcodes &amp; sticky posts!" class="title">Section shortcodes &amp; sticky posts!</a>
                            ...
                            <div class="hentry-post group">
                                ...
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html" title="Nice &amp; Clean. The best for your blog!" class="title">Nice &amp; Clean. The best for your blog!</a>
                                    <p class="post-date">September 24, 2012</p>
                                </div>
                            </div>
                            <div class="hentry-post group">
                                ...
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html" title="Another theme by YIThemes!" class="title">Another theme by YIThemes!</a>
                                    <p class="post-date">September 24, 2012</p>
                                </div>
                            </div>
                        </div>
