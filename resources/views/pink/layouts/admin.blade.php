...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(Config::get('settings.theme')) }}/css/style-minifield.css" /> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(Config::get('settings.theme')) }}/css/buttons.css" /> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(Config::get('settings.theme')) }}/css/cache-custom.css" /> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(Config::get('settings.theme')) }}/css/jquery-ui.css" /> <!-- MAIN THEME STYLESHEET -->
    ...
    <link rel='stylesheet' href='{{ asset(Config::get('settings.theme')) }}/css/font-awesome.css' type='text/css' media='all' />

    <!-- JAVASCRIPTs -->
    <script type="text/javascript" src="{{ asset(Config::get('settings.theme')) }}/js/jquery.js"></script>
    <script type="text/javascript" src="{{ asset(Config::get('settings.theme')) }}/js/jquery-ui.js"></script>
